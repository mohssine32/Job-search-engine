...
function FindJobSection() {
    ...
    const handleButtonClick = (buttonId: number) => {
        ...
        // Navigation vers la page des jobs
        navigate('/job')
    }
...
<div className='flex flex-col justify-around h-[600px] mx-[10px]  items-center md:flex-row md:h-[400px] md:justify-center md:gap-8' >
    ...
    <div className=' w-[300px] md:w-[400px] lg:w-[500px]'>
        ...
        <button 
            ...
            className={`bg-black text-white p-[15px] rounded-md mt-[10px] transition-all duration-300 transform cursor-pointer ${
                clickedButton === 1 ? 'scale-95 shadow-lg' : 'hover:bg-gray-800 hover:shadow-md active:scale-95'
            }`}
        >
            Trouver un job
        </button>
...
<div className='flex flex-col justify-around h-[600px] mx-[10px]  items-center md:flex-row md:h-[400px] md:justify-center md:gap-8' >
    <div className=' w-[300px] md:w-[400px] lg:w-[500px]'>
        ...
        <button 
            ...
            className={`bg-black text-white p-[15px] rounded-md mt-[10px] transition-all duration-300 transform cursor-pointer ${
                clickedButton === 2 ? 'scale-95 shadow-lg' : 'hover:bg-gray-800 hover:shadow-md active:scale-95'
            }`}
        >
            Trouver un job
        </button>
...
<div className='flex flex-col justify-around h-[600px] mx-[10px]  items-center md:flex-row md:h-[400px] md:justify-center md:gap-8' >
    ...
    <div className=' w-[300px] md:w-[400px] lg:w-[500px]'>
        ...
        <button 
            ...
            className={`bg-black text-white p-[15px] rounded-md mt-[10px] transition-all duration-300 transform cursor-pointer ${
                clickedButton === 3 ? 'scale-95 shadow-lg' : 'hover:bg-gray-800 hover:shadow-md active:scale-95'
            }`}
        >
            Trouver un job
        </button>
